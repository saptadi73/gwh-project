    ...
    <NavbarGwh />
        <div class="container relative mt-20">
            <div class="grid grid-cols-1 pb-6 text-center mt-10">
                <h3 class="mb-6 md:text-3xl text-2xl md:leading-normal leading-normal font-semibold">Sewa Lapak Bisa Bikin Bisnis Anda Moncer</h3>

                <p class="text-slate-400 max-w-xl mx-auto">Jika anda ingin secepatnya tajir melintir, segera putuskan lapak kami yang ideal untuk bisnis anda. Lokasi strategis didukung landscape yang ciamik buat menarik pembeli dagangan anda. Ada diskon bagus untuk tahun pertama.</p>
            </div><!--end grid-->
...
export default {
    ...
    data() {
        return {
            datas: [
                {
                    image: require('../../../../assets/images/listing/lapak_1.jpg'),
                    country: 'Depok, Jawa Barat',
                    city: 'Grand City Depok',
                    tarif: 'Rp 2,8jt /bulan',
                    rating: 73,
                    discount: '10% Off',
                },
                {
                    image: require('../../../../assets/images/listing/lapak_2.jpg'),
                ...
                {
                    image: require('../../../../assets/images/listing/lapak_3.jpg'),
                    country: 'Alam Sutra, Tangsel',
                    city: 'Alam Sutra',
                    tarif: 'Rp 2,5jt /bulan',
                    rating: 12,
                    discount: '25% Off',

                },
                {
                    image: require('../../../../assets/images/listing/lapak_4.jpg'),
                    country: 'Kebayoran, Jaksel',
                    city: 'Gandaria City',
                    tarif: 'Rp 4,5jt /bulan',
                    rating: 11,
                    discount: '20% Off',

                },
                {
                    image: require('../../../../assets/images/listing/lapak_5.jpg'),
                    country: 'Muara Angke, Jakarta',
                    city: 'Pasar Ikan',
                    tarif: 'Rp 5jt /bulan',
                    rating: 75,
                    discount: '25% Off',
                ...
                {
                    image: require('../../../../assets/images/listing/lapak_6.jpg'),
