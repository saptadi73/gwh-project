    ...
    <section
        ...
        <div class="container relative">
            <div class="grid grid-cols-1 pb-8 text-center mt-10">
                <h3 class="text-3xl leading-normal tracking-wider font-semibold text-white">New Zealand’s South Island
                    brims with majestic</h3>
            </div><!--end grid-->
        </div><!--end container-->
        ...
        <div class="absolute text-center z-10 bottom-5 start-0 end-0 mx-3">
            <ul class="tracking-[0.5px] mb-0 inline-block">
                <li
                    ...
                    <router-link to="/index">Travosy</router-link>
                </li>
...
import image from '../../../../assets/images/listing/1.jpg';
...
import tourdetail from '@/components/tour-detail/tour-detail.vue';
