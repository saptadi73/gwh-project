    ...
    <section class="relative md:py-24 py-16">
                    ...
                    <div class="grid grid-cols-1 gap-6">
                        <div v-for="item in blogs" :key="item" class="group relative overflow-hidden">
                            <div class="relative overflow-hidden rounded-md shadow dark:shadow-gray-800">
                                <img :src="item.image" class="group-hover:scale-110 group-hover:rotate-3 duration-500"
                                    alt="">
        ...
        item.status }}</span>
                            ...
                            <div class="mt-6">
                                ...
                                <div class="mt-3">
                                    <router-link to="/blog-detail"
                                        class="hover:text-red-500 inline-flex items-center">Read
                                        More <i data-feather="chevron-right" class="size-4 ms-1"></i></router-link>
                                </div>
                            </div>
                        </div><!--end content-->
                    </div><!--end grid-->
