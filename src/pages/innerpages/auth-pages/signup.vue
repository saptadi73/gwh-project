        ...
        <div class="container relative z-3">
            <div class="flex justify-center">
                <div
                    ...
                    <router-link to="/"><img src="../../../assets/images/logo-icon.png" class="mx-auto"
                            alt=""></router-link>
                    <h5 class="my-6 text-xl font-semibold">Signup</h5>
                    <form class="text-start" action="signup-success.html">
                        <div class="grid grid-cols-1">
                            <div class="mb-4">
                                <label class="font-semibold" for="RegisterName">Your Name:</label>
                                <input id="RegisterName" type="text"
                                    class="mt-3 w-full py-2 px-3 h-10 bg-transparent dark:bg-slate-900 dark:text-slate-200 rounded outline-none border border-gray-100 dark:border-gray-800 focus:ring-0" required
                                    placeholder="Harry" >
                            </div>
                            ...
                            <div class="mb-4">
                                <div class="flex items-center w-full mb-0">
                                    ...
                                    <label class="form-check-label text-slate-400" for="AcceptT&amp;C">I Accept <a
                                            href="" class="text-red-500">Terms And Condition</a></label>
                                </div>
                            </div>
                            ...
                            <div class="text-center">
                                <span class="text-slate-400 me-2">Already have an account ? </span> <router-link
                                    to="/login" class="text-black dark:text-white font-bold inline-block">Sign
                                    in</router-link>
                            </div>
                        </div>
                    </form>
