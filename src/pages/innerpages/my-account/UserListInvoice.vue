    ...
    <div class="container relative md:mt-24 mt-16">
      <div class="md:flex">
        ...
        <div class="lg:w-3/4 md:w-2/3 md:px-3 mt-6 md:mt-0">
          <div
            class="rounded-md shadow dark:shadow-gray-800 bg-white dark:bg-slate-900"
          >
            <div class="p-6 border-b border-gray-100 dark:border-gray-700">
              <h5 class="text-xl font-semibold">Daftar Invoice</h5>
              <p class="text-slate-400 mt-2">
                Invoice yang dibayarkan sebelum jatuh tempo akan mendapatkan bonus point reward
              </p>
            </div>
            ...
            <div class="px-6">
              <div class="relative overflow-x-auto">
                ...
                >
                  ...
                  <tbody>
                    ...
                    >
                      ...
                      >
                        124510 Tagihan Kamar 405"
                      </th>
                      <td class="px-6 py-4">paid</td>
                      <td class="px-6 py-4">22 Maret 2024</td>
                      <td class="px-6 py-4"><router-link to="/user-invoice-gwh"><i data-feather="check-square"></i></router-link></td>
                    </tr>
                    <tr
                      class="bg-white border-b dark:bg-gray-800 dark:border-gray-700"
                    >
                      ...
                      <th
                        ...
                        class="px-6 py-4 font-medium text-gray-900 whitespace-nowrap dark:text-white"
                      >
                        1245567 Tagihan Kamar 405"
                      </th>
                      <td class="px-6 py-4">paid</td>
                      <td class="px-6 py-4">22 April 2024</td>
                      <td class="px-6 py-4"><router-link to="/user-invoice-gwh"><i data-feather="check-square"></i></router-link></td>
                    </tr>
                    <tr
                      class="bg-white border-b dark:bg-gray-800 dark:border-gray-700"
                    >
                      ...
                      <th
                        ...
                        class="px-6 py-4 font-medium text-gray-900 whitespace-nowrap dark:text-white"
                      >
                        124778 Tagihan Kamar 405"
                      </th>
                      <td class="px-6 py-4">paid</td>
                      <td class="px-6 py-4">22 Mei 2024</td>
                      <td class="px-6 py-4"><router-link to="/user-invoice-gwh"><i data-feather="check-square"></i></router-link></td>
                    </tr>
                  </tbody>
                </table>
                <ul class="mt-5">
                    <li>
                        <i>
                            Invoice yang dibayarkan 1-7 hari sebelum jatuh tempo mendapatkan 10 point
                        </i>
                    </li>
                    <li>
                        <i>
                            Invoice yang dibayarkan sebelum 7 hari sebelum jatuh tempo mendapatkan 30 point
                        </i>
                    </li>
                </ul>
              </div>
        ...
        <form>
          <div class="grid md:grid-cols-12 grid-cols-1 gap-4">
            ...
            <div class="lg:col-span-6">
              <div class="text-start">
                <label for="ex_month" class="form-label font-medium"
                  >Month :</label
                >
                <select
                  id="ex_month"
            ...
            <div class="lg:col-span-6">
              <div class="text-start">
                <label for="ex_year" class="form-label font-medium"
                  >Year :</label
                >
                <select
                  id="ex_year"
            ...
            <div class="md:col-span-12">
              <div class="text-start">
                <label for="card_names" class="form-label font-medium"
                  >Cards :</label
                >
                <select
                  id="card_names"
          ...
          <div class="mt-4">
            <button
              ...
              id="submit"
              name="send"
              class="py-2 px-5 font-semibold tracking-wide align-middle duration-500 text-base text-center bg-red-500 text-white rounded-md justify-center flex items-center"
            >
              Add Card
            </button>
          </div>
...
<script>
import account from "@/components/account-tab.vue";
