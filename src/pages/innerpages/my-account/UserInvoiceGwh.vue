                                ...
                                <div>
                                    ...
                                    <div class="flex mt-4">
                                        ...
                                        <a href="#" target="_blank"
                                            class="text-red-500 dark:text-white font-medium">www.kahuripan.com</a>
                                    </div>
                                </div>
                                    ...
                                    <ul class="list-none">
                                        <li class="flex mt-3">
                                            ...
                                            <a href="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d39206.002432144705!2d-95.4973981212445!3d29.709510002925988!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x8640c16de81f3ca5%3A0xf43e0b60ae539ac9!2sGerald+D.+Hines+Waterwall+Park!5e0!3m2!1sen!2sin!4v1566305861440!5m2!1sen!2sin"
                                                data-type="iframe" class="lightbox text-slate-400">Blok C4,
                                                <br> Pakubuwono Village, Kebayoran, Jakarta1</a>
                                        </li>

                                        <li class="flex mt-3 ms-0">
                                            <i data-feather="mail" class="size-4 me-3 mt-1"></i>
                                            <a href="mailto:contact@example.com"
                                                class="text-slate-400">info@kahuripan.com</a>
                                        </li>

                                        <li class="flex mt-3 ms-0">
                                            <i data-feather="phone" class="size-4 me-3 mt-1"></i>
                                            <a href="tel:+152534-468-854" class="text-slate-400">(62)-815-2018-2651)</a>
                                        </li>
                                    </ul>
                                </div>
                            </div>
                            ...
                            <div class="md:flex justify-between">
                                ...
                                <div class="mt-4 md:mt-0">
                                    <div class="text-slate-400 text-center md:text-end">
                                        <h6 class="mb-0"><router-link to="/terms" target="_blank"
                                                class="text-red-500">Terms & Conditions</router-link></h6>
                                    </div>
                                </div>
                            </div>
                        </div>
