                       ...
                       <div class="flex items-center justify-between">
                           <ul class="list-none">
                               <li class="inline-flex items-center">
                                   ...
                                   <span class="ms-2 text-slate-300">Senin-Sabtu: 09:00 to 17:00</span>
                               </li>
                               <li class="inline-flex items-center ms-2">
                                   <i data-feather="map-pin" class="text-red-500 size-4"></i>
                                   <span class="ms-2 text-slate-300">Jakarta, Indonesia</span>
                               </li>
                           </ul>
                           ...
                           <ul class="list-none">
                               <li class="inline-flex items-center">
                                   ...
                                   <a href="mailto:contact@example.com" class="ms-2 text-slate-300 hover:text-slate-200">sales@kahuripan.com</a>
                               </li>
                               <li class="inline-flex items-center ms-2">
                                   <ul class="list-none">
