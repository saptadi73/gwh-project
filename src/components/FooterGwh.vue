                       ...
                       <div class="py-[60px] px-0">
                           <div class="grid md:grid-cols-12 grid-cols-1 gap-6">
                               ...
                               <div class="lg:col-span-3 md:col-span-4">
                                   <div class="lg:ms-8">
                                       <h5 class="tracking-[1px] text-gray-100 font-semibold">Kantor</h5>
                                       <h5 class="tracking-[1px] text-gray-100 mt-6">Kahuripan Lestari</h5>

                                       <div class="flex mt-4">
                                           <i data-feather="map-pin" class="size-4 text-red-500 me-2 mt-1"></i>
                                           <div class="">
                                               <h6 class="text-gray-300">Blok C4, No.5, Pakubowon Village <br> Kebayoran Baru 10928, <br> Jakarta Selatan, Jakarta</h6>
                                           </div>
                                       </div>
                                       ...
                                       <div class="flex mt-4">
                                           ...
                                           <div class="">
                                               <a href="mailto:contact@example.com" class="text-slate-300 hover:text-slate-400 duration-500 ease-in-out">sales@kahuripan.com</a>
                                           </div>
                                       </div>
                               ...
                               <div class="lg:col-span-3 md:col-span-4">
                                   <div class="lg:ms-8">
                                       ...
                                       <ul class="list-none footer-list mt-6">
                                           <li><router-link to="/aboutus" class="text-gray-300 hover:text-gray-400 duration-500 ease-in-out"><i class="mdi mdi-chevron-right"></i> About us</router-link></li>
